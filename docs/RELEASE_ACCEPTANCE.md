...
| 3 | Qualification required | `src/nimbledesk/testing/fixture_app.py` provides a state-file and event-log oracle; `tests/test_fixture_app.py` verifies the fixture contract. | Run the black-box fixture matrix on macOS, Windows, GNOME Wayland/X11, and KDE. |
